...
export default function EditSemester() {
  ...
  const [mon, setmon] = useState(subjects.monday.subjects[0].id);
  const [tue, settue] = useState(subjects.tuesday.subjects[0].id);
  const [wed, setwed] = useState(subjects.wednesday.subjects[0].id);
  const [thu, setthu] = useState(subjects.thursday.subjects[0].id);
  const [fri, setfri] = useState(subjects.friday.subjects[0].id);
